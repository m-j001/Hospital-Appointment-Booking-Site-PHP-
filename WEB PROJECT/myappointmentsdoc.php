...
$select = "SELECT * FROM `appointments` WHERE doctor = '$firstname' ORDER BY id DESC LIMIT 4";
...
<head>
    ...
    <link rel="stylesheet" href="\WEB PROJECT\css\style22.css">
  <style>
...
/.table0 tr {border-radius: 5px;}

.table0 tr:hover {background-color: #17212B;}
...
<div class="nave">
<form action="includes/logoutdoc.php" method="POST"> 
...
<nav>
  <ul>
    <li>
      <div class="home-icon"><a href="dashboarddoc.php">
        <div class="roof">
    ...
    <li>
      <div class="work-icon"><a href="appointmentsdoc.php">
        <div class="paper"></div>
        <div class="lines"></div>
        <div class="lines"> </div>
    ...
    <li>
      <div class="mail-icon"><a href="myappointmentsdoc.php">
        <div class="mail-base">
...
<div class="tablecontainer">
 ...
 <th> Doctor To Visit </th> 
 <th> Patient Email </th> 
 <th> Date Created </th> 
 <th> Status / Approved Meeting Time </th> 
 <th> Set Meeting Time </th>
...
<td> <?php echo $row['id'] ?></td> 
 ...
 <td> <?php echo $row['hosnum'] ?></td>
 <td> <?php echo $row['doctor'] ?></td>
 <td> <?php echo $row['email'] ?></td>
 <td> <?php echo $row['time'] ?></td>
 <td> <?php echo $row['status'] ?></td>

 <form action="includes/settimedoc.php" method="POST">
 <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
 <td> <input type="text" name="time" value="" class="input2"> <button type="submit" name="settime" >Save</button></td>
